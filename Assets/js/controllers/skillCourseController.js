app.controller('SkillCourseController', ['$scope', '$rootScope', '$compile', '$location', 'BaseService',
    function ($scope, $rootScope, $compile, $location, BaseService) {
        ...
        $scope.dataLog = null;
        $scope.dataInfo = [];
        $scope.uriController = "SkillCourse";
        $scope.textFile = {};
        dateparam = '';
        $scope.dataID = {
            ID: ''
            ...
            if (dataSource != null) {
                ...
                $scope.table = $('#table_list').dataTable({
                    ...
                    "columns": [
                        ...
                        {
                            "data": "วันที่แลก", "class": "text-center"
                        },
                        {
                        ...
                        ,
                        {
                            "data": "Passenger_Number", "class": "text-center"
                        }
                        ,
                        {
