app.controller('RoadsideController', ['$scope', '$rootScope', '$compile', '$location', 'BaseService',
    function ($scope, $rootScope, $compile, $location, BaseService) {
        ...
        $scope.retrieveAll = function () {
            ...
            BaseService.post($scope.uriController, 'GetByDate/baac', data).then(
                function (response) {
            ...
            if (dataSource != null) {
                ...
                $scope.table = $('#table_list').dataTable({
                    ...
                    "columns": [
                        ...
                        {
                            "data": "ชื่อสกุล", "class": "text-center"
                        },
                        {
                        ...
                        {
                            "data": "actual_service_amount", "class": "text-center"
                        },
                        {
                            "data": "Create_by", "class": "text-center"
                        },
                        {
                            "data": "incident_remark", "class": "text-center"
                        }
                    ],
