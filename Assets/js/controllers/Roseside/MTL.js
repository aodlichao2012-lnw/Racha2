app.controller('RoadsideController', ['$scope', '$rootScope', '$compile', '$location', 'BaseService',
    function ($scope, $rootScope, $compile, $location, BaseService) {
        ...
        $scope.retrieveAll = function () {
            ...
            BaseService.post($scope.uriController, 'GetByDate/mtl', data).then(
                function (response) {
            ...
            if (dataSource != null) {
                ...
                $scope.table = $('#table_list').dataTable({
                    ...
                    "columns": [
                        ...
                        {
                            "data": "Client_ID", "class": "text-center"
                        },
                        {
                            "data": "Cust_Class", "class": "text-center"
                        },
                        {
                        ...
                        {
                            "data": "Case_No", "class": "text-center"
                        },
                        {
                            "data": "Scope_Service", "class": "text-center"
                        },
                        {
