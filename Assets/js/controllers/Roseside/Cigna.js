app.controller('RoadsideController', ['$scope', '$rootScope', '$compile', '$location', 'BaseService',
    function ($scope, $rootScope, $compile, $location, BaseService) {
        ...
        $scope.retrieveAll = function () {
            ...
            BaseService.post($scope.uriController, 'GetByDate/cigna', data).then(
                function (response) {
            ...
            if (dataSource != null) {
                ...
                $scope.table = $('#table_list').dataTable({
                    ...
                    "columns": [
                        ...
                        {
                            "data": "Update_Group", "class": "text-center"
                        },
                        {
                        ...
                        {
                            "data": "Provd_Name", "class": "text-center"
                        },
                        {
                            "data": "Service_Cost", "class": "text-center"
                        },
                        {
