app.controller('RoadsideController', ['$scope', '$rootScope', '$compile', '$location', 'BaseService',
    function ($scope, $rootScope, $compile, $location, BaseService) {
        ...
        $scope.retrieveAll = function () {
            ...
            BaseService.post($scope.uriController, 'GetByDate/tbank', data).then(
                function (response) {
            ...
            if (dataSource != null) {
                ...
                $scope.table = $('#table_list').dataTable({
                    ...
                    "columns": [
                        ...
                        {
                            "data": "C_TBANK_FULL_NAME", "class": "text-center"
                        },
                        {
                            "data": "CUST_ID", "class": "text-center"
                        },
                        {
                            "data": "C_TBANK_LEVEL_CARD", "class": "text-center"
                        },
                        {
                            "data": "ทะเบียนรถ", "class": "text-center"
                        },
                        {
                            "data": "ยี่ห้อรถ", "class": "text-center"
                        },
                        {
                        ...
                        {
                            "data": "Scope_Name", "class": "text-center"
                        },
                        {
                            "data": "Service_Name", "class": "text-center"
                        },
                        {
                            "data": "ผู้ให้บริการ", "class": "text-center"
                        },
                        {
                            "data": "ค่าบริการ", "class": "text-center"
                        },
                        {
                            "data": "agent_name", "class": "text-center"
                        },
                        {
                            "data": "etc", "class": "text-center"
                        }
                    ],
