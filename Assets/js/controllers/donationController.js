app.controller('DonationController', ['$scope', '$rootScope', '$compile', '$location', 'BaseService',
            ...
            if (dataSource != null) {
                ...
                $scope.table = $('#table_list').dataTable({
                    ...
                    "columns": [
                        ...
                        {
                            "data": "Donation_Name", "class": "text-center"
                        },
                        {
                            "data": "Delivery_Remark", "class": "text-center"
                        },
                        {
