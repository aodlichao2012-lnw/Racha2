app.controller('HealthController', ['$scope', '$rootScope', '$compile', '$location', 'BaseService',
            ...
            if (dataSource != null) {
                ...
                $scope.table = $('#table_list').dataTable({
                    ...
                    "columns": [
                        ...
                        {
                            "data": "วันนัดหมาย", "class": "text-center"
                        },
                        {
                            "data": "Location_Name", "class": "text-center"
                        },
                        {
                            "data": "Gender", "class": "text-center"
                        },
                        {
                            "data": "Packget_Type", "class": "text-center"
                        },
                        {
                            "data": "Location_Name1", "class": "text-center"
                        },
                        {
