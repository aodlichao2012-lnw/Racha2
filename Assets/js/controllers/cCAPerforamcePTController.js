app.controller('CCAPerforamcePTController', ['$scope', '$rootScope', '$compile', '$location', 'BaseService',
    function ($scope, $rootScope, $compile, $location, BaseService) {
        ...
        $scope.dataLog = null;
        $scope.dataInfo = [];
        $scope.uriController = "CCAPerforamcePT";
        $scope.textFile = {};
        dateparam = '';
        $scope.dataID = {
            ID: ''
            ...
            if (dataSource != null) {
                ...
                $scope.table = $('#table_list').dataTable({
                    ...
                    "columns": [
                        ...
                        {
                            "data": "SaveDateTime", "class": "text-center"
                        },
                        {
                            "data": "DetailID", "class": "text-center"
                        },
                        {
                            "data": "Inbound_Petrol", "class": "text-center"
                        },
                        {
                            "data": "Inbound_Roadside", "class": "text-center"
                        },
                        {
                            "data": "Inbound_Infor", "class": "text-center"
                        },
                        {
                            "data": "Inbound_Other", "class": "text-center"
                        },
                        {
                            "data": "ประสานงานปั๊มน้ำมัน", "class": "text-center"
                        },
                        {
                            "data": "Out_ประสานงานPT", "class": "text-center"
                        },
                        {
                            "data": "Out_Provider", "class": "text-center"
                        },
                        {
                            "data": "Out_ประสานงานGSC", "class": "text-center"
                        },
                        {
