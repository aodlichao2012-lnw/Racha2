app.controller('HotelController', ['$scope', '$rootScope', '$compile', '$location', 'BaseService',
            ...
            if (dataSource != null) {
                ...
                $scope.table = $('#table_list').dataTable({
                    ...
                    "columns": [
                        ...
                        {
                            "data": "วันเข้า", "class": "text-center"
                        },
                        {
                            "data": "วันออก", "class": "text-center"
                        },
                        {
                            "data": "Book_Name_EN", "class": "text-center"
                        },
                        {
                        ...
                        {
                            "data": "Confirmation_No", "class": "text-center"
                        },
                        {
