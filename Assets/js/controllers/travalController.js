app.controller('TravelController', ['$scope', '$rootScope', '$compile', '$location', 'BaseService',
            ...
            if (dataSource != null) {
                ...
                $scope.table = $('#table_list').dataTable({
                    ...
                    "columns": [
                        ...
                        {
                            "data": "Book_Date", "class": "text-center"
                        },
                        {
                            "data": "Book_Time", "class": "text-center"
                        },
                        {
                            "data": "Flight", "class": "text-center"
                        },
                        {
                            "data": "Flight_Date", "class": "text-center"
                        },
                        {
                            "data": "Flight_Time", "class": "text-center"
                        },
                        {
                            "data": "สถานที่ไปรับ", "class": "text-center"
                        },
                        {
                            "data": "สถานที่ไปส่ง", "class": "text-center"
                        },
                        {
                            "data": "Address", "class": "text-center"
                        },
                        {
                            "data": "Book_Status", "class": "text-center"
                        },
                        {
                        ...
                        ,
                        {
                            "data": "Car_PlateNo", "class": "text-center"
                        }
                        ,
                        {
                            "data": "Car_Type", "class": "text-center"
                        },
                        {
                            "data": "Driver", "class": "text-center"
                        }
                        ,
                        {
                        ...
                        ,
                        {
                            "data": "น้องหอมจัง", "class": "text-center"
                        }
                    ],
