app.controller('SpecialExController', ['$scope', '$rootScope', '$compile', '$location', 'BaseService',
            ...
            if (dataSource != null) {
                ...
                $scope.table = $('#table_list').dataTable({
                    ...
                    "columns": [
                        ...
                        {
                            "data": "Room_Type", "class": "text-center"
                        },
                        {
                            "data": "CheckIn_Date", "class": "text-center"
                        },
                        {
                            "data": "CheckOut_Date", "class": "text-center"
                        },
                        {
                        ...
                        {
                            "data": "Adult_Number", "class": "text-center"
                        },
                        {
                            "data": "Child_Number", "class": "text-center"
                        },
                        {
