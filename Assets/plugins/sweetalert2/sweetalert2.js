...
;(function(window, document) {
  ...
  var defaultParams = {
    ...
    confirmButtonColor: '#21BAA0',
    confirmButtonClass: null,
    rejectButtonText: 'No',
    rejectButtonColor: '#F8C486',
    rejectButtonClass: null,
  ...
  function modalDependant() {
    ...
    switch (typeof arguments[0]) {
      ...
      case 'object':
        ...
        params.rejectButtonClass = arguments[0].rejectButtonClass || params.rejectButtonClass;
    ...
    var onButtonEvent = function(event) {
      ...
      var targetedReject = hasClass(target, 'reject');
      ...
      switch (e.type) {
        ...
        case 'focus':
          if (targetedConfirm) {
            ...
            target.style.backgroundColor = colorLuminance(params.rejectButtonColor, -0.1);
        ...
        case 'mousedown':
          if (targetedConfirm) {
            ...
            target.style.backgroundColor = colorLuminance(params.rejectButtonColor, -0.2);
          } else if (targetedCancel) {
        ...
        case 'click':
          ...
          } else if (targetedReject && params.callback && modalIsVisible) { // Clicked 'reject'
            params.callback('reject');
    ...
    $rejectButton.style.borderLeftColor = params.rejectButtonColor;
    $rejectButton.style.borderRightColor = params.rejectButtonColor;

    window.swal.toggleLoading = function() {
      $confirmButton.disabled = !$confirmButton.disabled;
      $rejectButton.disabled = !$rejectButton.disabled;
  ...
  window.swal.init = function() {
    var sweetHTML = '<div class="sweet-overlay" tabIndex="-1"></div><div class="sweet-alert" style="display: none" tabIndex="-1"> <div class="row phl"> <div class="col-xs-3"> <div class="icon error"><span class="x-mark"><span class="line left"></span><span class="line right"></span></span> </div><div class="icon warning"> <span class="body"></span> <span class="dot"></span> </div><div class="icon info"></div><div class="icon success"> <span class="line tip"></span> <span class="line long"></span> <div class="placeholder"></div><div class="fix"></div></div><div class="icon custom"></div></div><div class="col-xs-9 pln"> <h2>Title</h2> <p>Text</p></div></div><hr> <div class="row"> <div class="col-xs-12"> <button class="confirm">OK</button> <button class="reject">No</button> <button class="cancel">Cancel</button> </div></div></div></div>';
  ...
  function setParameters(params) {
    ...
    addClass($rejectBtn, params.rejectButtonClass);
